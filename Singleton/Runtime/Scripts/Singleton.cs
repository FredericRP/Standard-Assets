...
namespace FredericRP.GenericSingleton
{
  ...
  {
    // Tells if this singleton has to create himself if he is called and not present in the scene.
  ...
  /// 
  /// As a side note, this is made a MonoBehaviour because we need Coroutines.
  /// </summary>
  //[ExecuteInEditMode]
